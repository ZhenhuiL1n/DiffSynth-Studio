#!/usr/bin/env python3
"""
Compute FVD for the EWC seq_finetune experiments (body/head) against GT videos.

Closely mirrors the baseline FVD CLI but targets `EWC_experiment/seq_finetune`.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    ap = argparse.ArgumentParser(description="Compute FVD for seq_finetune body/head splits.")
    ap.add_argument("--root", default=default_root, help="Root containing seq_finetune and GT subfolders.")
    ap.add_argument("--experiment", default="seq_finetune", help="Experiment folder name under --root.")
