#!/usr/bin/env python3
"""
Run an EWC-protected body checkpoint on the body OOD set.

Mirrors `eval_head_ewc_ood.py` but targets the body dataset and prompt.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Root directory containing body splits (expects an `ood` folder).",
    )
    parser.add_argument(
        "--output_dir",
        default="out/bodys_ewc_ood_eval",
    ...
    parser.add_argument(
        ...
        help="Path to the body EWC (or equivalent) checkpoint.",
    )
...
def main() -> None:
    ...
    print(f"[INFO] Loaded body checkpoint: {args.lora_path}")
