...
def main():
    ...
    parser.add_argument("--n_epoch", type=int, default=13, help="Epoch number of the LoRA checkpoint")
    ...
    for media_path in media_paths:
        ...
        video = pipe(
            prompt= "a 360-degree orbit video of a person, high details, clear face, consistent, high fidelity", #"a rotation video of the human",
