...
# Sequence-level evaluation grid for full-finetuned checkpoint:
# left=input view, middle=FullFT output, right=GT back view.
#
# Outputs:
...
OUT_ROOT="${OUT_ROOT:-${ROOT_DIR}/outputs/eval_backview_full_grid_0008_01}"
...
echo "Running sequence grid evaluation (full checkpoint)"
...
[1:v]drawtext=text='FullFT':x=20:y=20:fontsize=42:fontcolor=white:box=1:boxcolor=black@0.55:boxborderw=10[v1];\
