...
def wan_parser():
    ...
    parser.add_argument("--adapter_isolation", action="store_true", help="Merge a frozen LoRA before training a new adapter.")
    parser.add_argument("--frozen_lora_checkpoint", type=str, default=None, help="Path to the frozen LoRA checkpoint for adapter isolation.")
    parser.add_argument("--frozen_lora_alpha", type=float, default=1.0, help="Scaling factor applied when merging the frozen adapter.")
    parser.add_argument("--train_adapter_name", type=str, default="default", help="Name for the trainable adapter (for bookkeeping).")
